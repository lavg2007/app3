...
Le système d'équation à linéariser est le suivant :
\begin{equation}
F_1 = \dot{h}(t) = \frac{1}{A}(q_f(t)+q_c(t)-q_v(t))
\end{equation}
\begin{equation}
F_2 = \dot{T}(t) = \frac{1}{A h(t)}(q_f(t)(T_f - T(t))+q_c(t)(T_f - T(t)))
\end{equation}
La première étape de la linéarisation consiste à résoudre le système au point d'équilibre. Pour se faire, on pose les dérivés à 0, car à l'équilibre il n'y a plus de changement.
Les conditions d'équilibres sont : 
\begin{center}
$q_v = q_f + q_c$ où $q_f = K \cdot q_c$
\end{center}
